...
<head>
  ...
  <!-- Favicons -->
  <link href="{{ asset('SnapFolio/assets/img/favicon.png') }}" rel="icon">
  <link href="{{ asset('SnapFolio/assets/img/apple-touch-icon.png') }}" rel="apple-touch-icon">
...
<body class="index-page">
  ...
  @include('partials.header',['social_links' => $social_links ?? []])
